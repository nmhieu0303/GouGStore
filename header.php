   ...
   <div class="header container-fluid hidden-xs hidden-sm">
    <div class="row">
     ...
     <ul class="header__menu list-unstyled d-flex mb-0 w-100 justify-content-end">
      <li class="header__item"><a class="header__item--link" href="https://ananas.vn/your-wishlist"><i
         class="fas fa-heart header__item-icon"></i>Yêu thích</a></li>
      <li class="header__item"><a class="header__item--link" href="./logout.php"><i
         class="fas fa-user header__item-icon"></i>Đăng xuất</a></li>
      <li class="header__item"><a class="header__item--link" href="https://ananas.vn/your-cart/"><i
         class="fas fa-shopping-cart header__item-icon"></i>
        Giỏ hàng (<span class="countProduct">0</span>)</a></li>
     </ul>
     <?php else: ?>
     <!--Chưa đăng nhập-->
     <ul class="header__menu list-unstyled d-flex mb-0 w-100 justify-content-end">
      <li class="header__item"><a class="header__item--link" href="./login.php"><i
         class="fas fa-user header__item-icon"></i>Đăng nhập</a></li>
      <li class="header__item"><a class="header__item--link" href="./register.php"><i
         class="fas fa-user header__item-icon"></i>Đăng kí</a></li>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
       <ul class="nav navbar-nav m-auto">
        <li class=" nav-item dropdown">
         <a class="nav-link dropdown-toggle" href="login.php" id="navbarDropdown">SẢN PHẨM <span
           class="caret"></span></a>
         <!-- Sub menu 1 -->
       ...
       <div id="carouselExampleInterval" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
         <div class="carousel-item active" data-interval="3000">
          <div class="cont-item d-block w-100 text-center"><a href="https://ananas.vn/faqs/">FREE SHIPPING VỚI HOÁ ĐƠN
            TỪ 800K !</a></div>
         </div>
         <div class="carousel-item" data-interval="3000">
          <div class="cont-item d-block w-100  text-center"><a href="https://ananas.vn/policy/">HÀNG 2 TUẦN NHẬN ĐỔI -
            GIÀY NỬA NĂM BẢO HÀNH</a></div>
         </div>
         <div class="carousel-item" data-interval="3000">
