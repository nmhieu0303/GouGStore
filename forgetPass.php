...
if (isset($_POST['email'])&&isset($_POST['username'])) {
    ...
    if (!$user) {
        ...
        $contentMail = 'You must follow this link to reset password your account: http://localhost/doan/resetPass.php?id='.$user['id'].'&code='. password_hash($user["email"],PASSWORD_DEFAULT) ;
